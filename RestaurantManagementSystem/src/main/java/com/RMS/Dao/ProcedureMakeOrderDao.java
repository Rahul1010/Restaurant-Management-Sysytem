...
public class ProcedureMakeOrderDao {
	private final JdbcTemplate jdbcTemplate = ConnectionUtil.getJdbcTemplate();

	public String placeOrder(String seatno,String items,String quantity,LocalTime orderTime,String message) {
        SimpleJdbcCall call = new SimpleJdbcCall(jdbcTemplate).withProcedureName("proc_make_order")
        ...
        String status = (String) execute.get("comments");
        return status;
